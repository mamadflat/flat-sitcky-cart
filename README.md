...
افزونه اختصاصی ووکامرس برای نمایش **قیمت و دکمه خرید ثابت پایین موبایل، از لحظه ورود به صفحه محصول**. در عرض ۷۶۸ پیکسل و بیشتر نوار نمایش داده نمی‌شود.
...
Download the **abzarak-mobile-cart-plugin** artifact from a passing GitHub Actions run. Extract the artifact wrapper and upload the contained `abzarak-mobile-cart-0.1.0.zip` through WordPress Plugins → Add New → Upload.
